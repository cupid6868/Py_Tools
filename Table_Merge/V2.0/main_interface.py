...
class MainInterface:
    def __init__(self, root):
        ...
        self.tools = {
            ...
            "batch_processor": {"name": "批量处理工具", "status": "开发中", "color": self.colors["gray"]},
    ...
    def create_widgets(self):
        ...
        self.add_button_hover_effect(self.batch_btn, self.colors["gray"], self.colors["light_gray"],
                                     self.colors["dark"])
